    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="edit-prescription-modal-label">{{ __('translate.prescription_edit') }}</h1>
            ...
            <form method="POST"
                ...
                <div class="modal-body">
                    <div class="form-floating mb-3">
                        <select id="edit-prescription-problem_id" name="problem_id" class="form-control" aria-label="" required>
                    ...
                    <div class="form-floating mb-3">
                        <select id="edit-prescription-medicine_id" name="medicine_id" aria-label="" required></select>
                    </div>

                    <div class="form-floating mb-3">
                        <input id="edit-prescription-prescription_date" type="date" name="prescription_date"
                            value="{{ date('Y-m-d') }}"
                    ...
                    <div class="form-floating mb-3">
                        <input id="edit-prescription-quantity" type="number" name="quantity" value="{{ old('quantity') }}"
                    ...
                    <div class="form-floating mb-3">
                        <input id="edit-prescription-dosage" type="text" name="dosage" value="{{ old('dosage') }}"
                    ...
                    <div class="form-floating mb-3">
                        <input id="edit-prescription-duration" type="text" name="duration" value="{{ old('duration') }}"
                    ...
                    <div class="form-check form-switch">
                        <input id="edit-prescription-print_notes" type="checkbox" name="print_notes" class="form-check-input"
                            role="switch">
                        <label class="form-check-label" for="edit-prescription-print_notes">{{ __('translate.print_notes') }}</label>
                    </div>

                    <div class="form-check form-switch">
                        <input id="edit-prescription-in_evidence" type="checkbox" name="in_evidence" class="form-check-input"
                            role="switch">
                        <label class="form-check-label" for="edit-prescription-in_evidence">{{ __('translate.in_evidence') }}</label>
                    </div>
...
<script type="module">
    $(function() {
        ...
        */
        ...
        $('#edit-prescription-medicine_id').select2({
            dropdownParent: $('#edit-prescription-modal'),
            width: '100%',
            ajax: {
