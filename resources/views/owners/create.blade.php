            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('clinics.owners.store', [$clinic->id]) }}"
                            ...
                            <div class="form-floating mb-3">
                                <input id="firstname" type="text"
                                    ...
                                    value="{{ old('firstname') }}" maxlength="100" required
                            ...
                            <div class="form-floating mb-3">
                                <input id="lastname" type="text"
                                    ...
                                    value="{{ old('lastname') }}" maxlength="100" required
                            ...
                            <div class="form-floating mb-3">
                                <input id="email" type="text"
                                    ...
                                    value="{{ old('email') }}" maxlength="255" required placeholder="{{ __('translate.email') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input id="phone_secondary" type="text"
                                    class="form-control @error('phone_secondary') is-invalid @enderror" name="phone_secondary"
                                    value="{{ old('phone_secondary') }}" maxlength="32" required
                            ...
                            <div class="form-floating mb-3">
                                <input id="ssn" type="text"
                                    ...
                                    value="{{ old('ssn') }}" maxlength="100" placeholder="{{ __('translate.ssn') }}">
